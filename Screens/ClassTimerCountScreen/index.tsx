  ...
  const getTimerData = async () => {
    try {
      ...
      if (myData !== null) {
        ...
        const classEndTIme = localDate.clone().add(duration, 'hours');
        console.log('Local Time:', classEndTIme.format('HH:mm:ss'));
        // Subtract 5 minutes from the new time
        const adjustedTime = classEndTIme.clone().subtract(5, 'minutes');
        console.log('Adjusted Time (5 minutes less):', adjustedTime.format('HH:mm:ss'));
